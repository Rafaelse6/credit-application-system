...
<p align="center">Rest API for Credit Application System</p>
<p align="center">
     <a alt="Java">
...
<ol>
	<li>Clone the project: <code>git clone </code></li>
	<li>Acces the root folder of the project: <code>cd </code></li> 
	<li>Run the instruction: <code>./gradlew bootrun</code></li>
</ol>
